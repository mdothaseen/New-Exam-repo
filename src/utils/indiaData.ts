...
export const indianDistricts: Record<string, string[]> = {
  ...
  // ... adding more states with their districts
  "Karnataka": [
  ...
  "Punjab": [
    ...
    "Mansa", "Moga", "Pathankot", "Patiala", "Rupnagar", "Sangrur", "Shaheed Bhagat Singh Nagar", 
  ...
  // ... add more states with their districts
};
